...
public class MyListener extends Action implements WebDriverEventListener{
	...
	public void afterAlertAccept(WebDriver driver) {
		...
		report.teststeps("The alert is accepted");
	}

	public void afterAlertDismiss(WebDriver driver) {
		System.out.println("The alert is dismissed");
		report.teststeps("The alert is dismissed");
	}
	...
	public void afterNavigateTo(java.lang.String url, WebDriver driver) {
		...
		report.teststeps("The browser loaded the URL "+ url);
	}
	...
	public void afterNavigateBack(WebDriver driver) {
		...
		report.teststeps("The browser has loaded the previous page from the history");
	}
	...
	public void afterNavigateForward(WebDriver driver) {
		...
		report.teststeps("The browser has loaded the next page from the history");
	}
	...
	public void afterNavigateRefresh(WebDriver driver) {
		...
		report.teststeps("The browser has reloaded successfully");
	}

	public void beforeFindBy(By by, WebElement element, WebDriver driver) {
		System.out.println("Trying to find element-> "+ by.toString());
		report.teststeps("Trying to find element-> "+ by.toString());
	}

	public void afterFindBy(By by, WebElement element, WebDriver driver) {
		System.out.println("Processing on element-> "+ String.valueOf(by));
		report.teststeps("Processing on element-> "+ by.toString());
	}

	public void beforeClickOn(WebElement element, WebDriver driver) {
		System.out.println("Trying to click on '"+ element.getText() + "' button");
		report.teststeps("Trying to click on '"+ element.getText() + "' button");
	}

	public void afterClickOn(WebElement element, WebDriver driver) {
		System.out.println("Clicked on button: " + element.getText());
		report.teststeps("Clicked on button: " + element.getText());
	}
	...
	public void afterSwitchToWindow(String windowName, WebDriver driver) {
		...
		report.teststeps("The driver is moved to the window with title "+driver.getTitle());
	}
